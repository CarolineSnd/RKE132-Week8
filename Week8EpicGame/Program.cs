...
string filePath = @"/Users/carolinesund/Projects";
...
//string[] heroes = { "Superman", "Batman", "Wonder Woman", "Catwoman" };
//string[] villains = { "Reimo", "Dracula", "Joker", "Poison Ivy", "Lea" };

string[] weapon = { "magic wand", "plastic fork", "laser eyes", "banana", "Lego brick"};
...
//{
   ...
   // {
       // static void Main(string[] args)
        //{
          //  string filePath = @"C:/Users/carolinesund/projects/heroes.txt";
